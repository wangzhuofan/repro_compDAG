...
for (signal in c(0.3,0.5,1,3,5)) {
  for (n in c(100,150)) {
    ...
    cat(paste0('The accuracy of compDAG in the misspecified simulation setting when n = ',n,' and pi = ',signal,' is:', sum(looic)/30))
    cat(paste0('The accuracy of COLP in the misspecified simulation setting when n = ',n,' and pi = ',signal,' is:', comp200101mat[1]/30))
    cat(paste0('The accuracy of bQCD in the misspecified simulation setting when n = ',n,' and pi = ',signal,' is:', comp200101mat[2]/30))
    cat(paste0('The accuracy of PC in the misspecified simulation setting when n = ',n,' and pi = ',signal,' is:', comp200101mat[3]/30))
  }
}
