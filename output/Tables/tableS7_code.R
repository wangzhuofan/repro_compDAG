        ...
        for (noisetype in allNoisetype)
        {
          for (simu_n in allN) {
            ...
            if(noisetype=="Multi5"){
              ...
              B0[5,4]=1
              if(method=="compDAG"){
                res = (lapply(result, function(x){x$gam}))
              }
              if(method=="PC"){
                res = lapply(result, function(x){
                  max_indices <- order(x$edge, decreasing = TRUE)[1:4]
            ...
            if(noisetype=="Multi3"){
              ...
              if(method=="PC"){
                res = lapply(result, function(x){
                  ...
                  i=3
                  j=2
                  b = x$adj[(px*(i-1)+1):(px*i),(px*(j-1)+1):(px*j)]
                  re <- c(a,b)
            ...
            if(noisetype=="Multi5"){
              ...
              if(method=="PC"){
                res = lapply(result, function(x){
                  ...
                  i=4
                  j=3
                  c = x$adj[(px*(i-1)+1):(px*i),(px*(j-1)+1):(px*j)]
                  i=5
                  j=4
                  d = x$adj[(px*(i-1)+1):(px*i),(px*(j-1)+1):(px*j)]
                  re <- c(a,b,c,d)
